...
{
    public class FacebookExternalLoginHandler : IRequestHandler<FacebookExternalLoginCommand, LoginResultViewModel>
    {
        ...
        public async Task<LoginResultViewModel> Handle(FacebookExternalLoginCommand request, CancellationToken cancellationToken)
        {
            try
            {
